...
<tr>
<td colspan=\"2\">
<h3 style=\"padding: 10px 15px; margin: 0px; color: #0d487a;\">'.$uname.' thought you would like</h3>
<p style=\"padding: 0px 15px 10px 15px; font-size: 12px; margin: 0px;\"><a href=\"'.$url.'\">'.$name.'</a></p>
<p><a href=\"'.$url.'\"><img src=\"'.$timage.'\" alt=\"\" /></a></p>
<p>'.$msg.'</p>
</td>
</tr>
<tr>
