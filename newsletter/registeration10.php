...
<tr>
<td colspan=\"2\">
<h3 style=\"padding: 10px 15px; margin: 0px; color: #0d487a;\">Hi '.$full_name.',</h3>
...
<p>'.$cfull_name.' featured your product <a href=\"'.$prodLink.'\">'.$product_name.'</a>. To see '.$cfull_name.'\\\'s profile <a href=\"'.base_url().'user/'.$user_name.'\">click here</a>.</p>
</td>
<td valign=\"top\" width=\"50%\" style=\"font-size: 12px; padding: 10px 15px;\">
<p>&nbsp;</p>
