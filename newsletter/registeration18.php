...
<tr>
<td colspan=\"2\">
<h3 style=\"padding: 10px 15px; margin: 0px; color: #0d487a;\">Hi &nbsp;admin,</h3>
...
<p>'.$full_name.' commented on <a href=\"'.$prodLink.'\">'.$product_name.'</a>. To see '.$full_name.'\\\'s profile <a href=\"'.base_url().'user/'.$user_name.'\">click here</a>.</p>
</td>
<td style=\"font-size: 12px; padding: 10px 15px;\" width=\"50%\" valign=\"top\">
<p>&nbsp;</p>
