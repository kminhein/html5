...
function loadExample() {
    ...
    $("div.viewsource").each(function () {
        var el = $(this),
                pre = $('<pre class="html"></pre>').text(el.html());

        if (el.attr("data-linked")) {
            $('#' + el.attr("data-linked")).append(pre);
        }
        else {
            el.after(pre);
        }
    ...
    $("style.viewsource").each(function (i, el) {
        var style = $(this),
                linkedTo = style.attr("data-linked") ? "#" + style.attr("data-linked") : "body",
                pre = $('<pre class="js"></pre>').text(style.html());

        if (style.attr("data-linked")) {
            $('#' + style.attr("data-linked")).append(pre);
        }
        else {
            style.after(pre);
        }
    ...
    $("script.viewsource").each(function (i, el) {
        var script = $(this),
                pre = $('<pre class="js"></pre>').text(script.html());

        if (script.attr("data-linked")) {
            $('#' + script.attr("data-linked")).append(pre);
        }
        else {
            script.after(pre);
        }
...
(function (E, B) {
    ...
    var t = E.document, c = function () {
        ...
        b.fn = b.prototype = {init: function (j,
                    s) {
                var v, z, H;
                if (!j)
                    return this;
