$(function() {
  ...
  validate:       true
	...
	========================*/
		...
		$('.user_seller :checkbox').iphoneStyle({ checkedLabel: 'User', uncheckedLabel: 'Seller' });
...
$("#adv2").idTabs(function(id,list,set){ 
  ...
  $("#commentForm,#addproduct_form").validate();
  ...
  $("#addsubadmin_form").validate({
	  ...
	  messages: {
		email:{
			required: "Please enter sub-admin email address",
			email:"Please enter a valid email address"
		},
		admin_name: {
		...
		admin_password: {
			required: "Please enter new admin password",
			minlength: "Password must consist of at least 5 characters"
		}
	  }
  });
  $('#giftsettings_form').validate();
