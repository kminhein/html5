	...
	<div class="container shoppage">
        ...
        ?>   
            <div class="shop_browse">
            	...
            	<h3><?php if($this->lang->line('browse') != '') { echo stripslashes($this->lang->line('browse')); } else echo "Browse"; ?></h3>
...
//                	$cat_img = base_url().'images/no_image.gif';
 ...
 <?php 
				...
				<div class="might-fancy">
					<h3 style="font-size:18px;font-family: 'Muli',sans-serif !important;"><?php if($this->lang->line('whats_new') != '') { echo stripslashes($this->lang->line('whats_new')); } else echo "What's New"; ?> <a style="margin-left: 10px;font-size:12px;" href="shopby/all"><?php if($this->lang->line('see_more') != '') { echo stripslashes($this->lang->line('see_more')); } else echo "See more"; ?></a></h3>
