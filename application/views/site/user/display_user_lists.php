      ...
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            ...
            <li><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/lists" class="current"><b><?php if($this->lang->line('display_lists') != '') { echo stripslashes($this->lang->line('display_lists')); } else echo "Lists"; ?></b> <small><?php echo $userProfileDetails->row()->lists;?></small></a></li>
          ...
          ?>
            <li class="big clear">
              ...
              <a href="user/<?php echo $userProfileDetails->row()->user_name;?>/lists/<?php echo  $listDetailsRow->id;?>" class="figure-img"> 
              ...
              <span class="figcaption" style="text-align:center;"><b><?php echo $listDetailsRow->name;?></b> (<?php echo $listProdCount;?> <?php if($this->lang->line('user_things') != '') { echo stripslashes($this->lang->line('user_things')); } else echo "things"; ?>)</span> 
              </a> 
              <?php 
              if ($loginCheck == $userProfileDetails->row()->id){
              ?>
