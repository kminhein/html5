      ...
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            ...
            <li><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/owns" class="current"><b><?php if($this->lang->line('display_owns') != '') { echo stripslashes($this->lang->line('display_owns')); } else echo "Owns"; ?></b> <small><?php echo $userProfileDetails->row()->own_count;?></small></a></li>
          ...
          <?php if (($ownsProductDetails != '' && $ownsProductDetails->num_rows()>0) || ($notSellProducts != '' && $notSellProducts->num_rows()>0)){?>
          <ol class="stream">
          <?php 
          foreach ($ownsProductDetails->result() as $productLikeDetailsRow){
          ...
          <?php }else {?>
          <div class="no-result">
          <?php if ($userProfileDetails->row()->own_count>0){?>
          ...
          <?php }else {?>
          	<b><?php echo $userProfileDetails->row()->full_name;?></b> <?php if($this->lang->line('display_owns_yet') != '') { echo stripslashes($this->lang->line('display_owns_yet')); } else echo "has not owns any product yet"; ?>.
          <?php }?>
          </div>
          <?php }?>
        </div>
