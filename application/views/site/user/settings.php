	...
	<div class="container set_area">
		...
		<div class="section account">
			...
			<fieldset class="frm">
				...
				<input name="gender" class="setting_gender gender" <?php if ($userDetails->row()->gender=='Unspecified'){echo 'checked="checked"';}?> value="Unspecified" id="gender3" type="radio">
				...
				<label for="gender1" class="label gender"><?php if($this->lang->line('settings_male') != '') { echo stripslashes($this->lang->line('settings_male')); } else echo "Male"; ?></label>
				<input name="gender" class="setting_gender gender" <?php if ($userDetails->row()->gender=='Female'){echo 'checked="checked"';}?> value="Female" id="gender2" type="radio">
