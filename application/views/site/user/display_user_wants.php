      ...
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            ...
            <li><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/wants" class="current"><b><?php if($this->lang->line('display_wants') != '') { echo stripslashes($this->lang->line('display_wants')); } else echo "Wants"; ?></b> <small><?php echo $userProfileDetails->row()->want_count;?></small></a></li>
          ...
          <?php if (($wantProductDetails != '' && $wantProductDetails->num_rows()>0)|| ($notSellProducts != '' && $notSellProducts->num_rows()>0)){?>
          <ol class="stream">
          <?php 
          foreach ($wantProductDetails->result() as $productLikeDetailsRow){
          ...
          <div class="no-result">
          <?php 	
          	if ($userProfileDetails->row()->want_count > 0){
          ?>
          ...
          <?php }else {?>
          	<b><?php echo $userProfileDetails->row()->full_name;?></b> <?php if($this->lang->line('display_no_prod') != '') { echo stripslashes($this->lang->line('display_no_prod')); } else echo "has not want any product yet"; ?>.
          <?php }?>	
          </div>
          <?php }?>
        </div>
