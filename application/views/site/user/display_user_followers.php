...
<?php if($flash_data != '') { ?>
      ...
      <div id="content">
	    ...
	    <h2 class="tit"><span class="username"><a href="user/<?php echo $userProfileDetails->row()->user_name;?>"><?php echo $userProfileDetails->row()->full_name;?></a> /</span> <?php if($this->lang->line('display_followers') != '') { echo stripslashes($this->lang->line('display_followers')); } else echo "Followers"; ?></h2>
