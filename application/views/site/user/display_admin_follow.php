      ...
      <div id="content">
        <div class="wrapper timeline normal">
          <ul class="user-tab">
            ...
            <li><a href="user/<?php echo $userProfileDetails->row()->user_name;?>/follows" class="current"><b><?php if($this->lang->line('display_follows') != '') { echo stripslashes($this->lang->line('display_follows')); } else echo "Follows"; ?></b> <small><?php echo $listDetails->num_rows();?></small></a></li>
          </ul>
          <div class="top-menu">
          </div>
