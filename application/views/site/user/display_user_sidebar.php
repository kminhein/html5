          ...
          <?php }?>
            <div class="setting">
              ...
              <div class="menu-content">
                <ul>
                   <li><a href="<?php echo base_url();?>site/feed/user/<?php echo $userProfileDetails->row()->user_name;?>" target="_self"><?php if($this->lang->line('display_rss_feed') != '') { echo stripslashes($this->lang->line('display_rss_feed')); } else echo "RSS Feed"; ?></a></li>
