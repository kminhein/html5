...
#container-wrapper.sign form fieldset.frm p.hastext input{width:90% !important;}
...
<header id="header-new">
  <div class="inner">
    <div id="navigation-tsg" class="default">
      <div class="left">
                   ...
                   <?php if($social_login_session_array['social_email_name'] != '') { ?> <h3 class="stit">Your email address : <?php echo $social_login_session_array['social_email_name'];?> </h3><?php } ?>
                    ...
                    <small class="url"><?php if($this->lang->line('signup_sitepage') != '') { echo $yoursitepage; } else echo "Your ".$siteTitle." page:"; ?> <?php echo base_url();?>user/<b>USERNAME</b></small></p>
                   	...
                   	<?php if($social_login_session_array['loginUserType'] != 'google') { ?>
						...
						<input type="<?php if($social_login_session_array['loginUserType'] != 'google') echo 'text'; else echo 'hidden'; ?>" id="email" class="email" name="email" value="<?php echo $social_login_session_array['social_email_name'];?>" /><?php if($social_login_session_array['loginUserType'] != 'google') { ?></p>
					<?php } ?>
                    
                   <?php if($social_login_session_array['social_login_name'] == '') {?> 
					<p><label class="label"><?php if($this->lang->line('signup_password') != '') { echo stripslashes($this->lang->line('signup_password')); } else echo "Password"; ?><span class="error-label" id="error-user_password"></span></label><?php } ?>
                    <?php $pwdLength = 10;
