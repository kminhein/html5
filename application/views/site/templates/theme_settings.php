...
?>
#navigation-tsg [class^="feed-"], #navigation-tsg .feed-notification li:hover, .header_top, #navigation-tsg [class^="menu-contain"], #navigation-tsg .menu-contain-gift li .submenu-contain ul, #navigation-tsg .gnb.hover [class^="mn-"],
...
#navigation-tsg .gnb,#navigation-tsg .search
{
	border-left: 1px solid <?php echo $themeLayout[1]['value'];?>;
}
#navigation-tsg .gnb.current, #navigation-tsg .gnb.hover,
...
#navigation-tsg .left .gnb:last-child,#navigation-tsg .left .gnb.hover:last-child
{
	border-right: 1px solid <?php echo $themeLayout[1]['value'];?>;
}
#navigation-tsg [class^="menu-contain"] ul,#navigation-tsg .menu-contain-cart tbody td, #navigation-tsg .menu-contain-cart tbody th
{
...
?>
#navigation-tsg a,#navigation-tsg [class^="menu-contain"] .hover li a,
#header-new .sign-cmt
{
...
?>
#navigation-tsg .gnb.hover [class^="mn-"], #navigation-tsg a:hover, #navigation-tsg .menu-contain-lang .selected,
#navigation-tsg [class^="menu-contain"] .hover a, #navigation-tsg [class^="menu-contain"] .hover li a:hover
{
...
?>
#navigation-tsg [class^="menu-contain"] a:hover, #navigation-tsg [class^="menu-contain"] .hover
{
