	...
	<div class="inner-wrapper">
		...
		<div class="info" style="position:static;">
			...
			<dl class="vcard" style="padding: 16px 12px 16px 16px;color: #89919c;">
				<dt>List</dt>
				<dd class="name">
					<strong class="fn" style="color:black;text-shadow:none;"><?php echo ucfirst($list_details->row()->list_value);?></strong>
...
<!-- 								
							<ul class="list-option">
								<li><a href="<?php echo base_url();?>colorsby/list/<?php echo $list_details->row()->id;?>" <?php if ($loginCheck==''){echo 'require_login="true"';}?> class="btn-clone-list" loid="3462155" lid="<?php echo $list_details->row()->id;?>">Clone this list</a></li>
							</ul>
	 -->							
							
							<ul class="list-option">
								<li><a href="<?php echo base_url();?>colorsby/list/<?php echo $list_details->row()->id;?>" lid="<?php echo $list_details->row()->id;?>" loid="3462155" list_name="<?php echo $list_details->row()->list_value;?>" class="btn-list-share"><?php if($this->lang->line('header_share') != '') { echo stripslashes($this->lang->line('header_share')); } else echo "Share"; ?></a></li>
							</ul>
						</div>
					</li>
...
<div id="content" class="wrapper-content content timeline">
	<header>
		<ul class="stats-list tab">
			...
			<li><a href="colorsby/list/<?php echo $list_details->row()->id;?>/followers">Followers<strong><?php echo $list_details->row()->followers_count;?></strong></a></li>
