...
<div class="lang-en wider no-subnav thing signed-out winOS">
	<div id="container-wrapper" style="margin-bottom:30px !important;">
		<div class="container ">
			<?php if($flash_data != '') { ?>
			...
			<div class="wrapper-content right-sidebar" style="background:none; box-shadow:none;margin-bottom:30px !important;"> 
				<div id="content" style="padding:0px; background:none;width: 680px;padding-bottom:30px;">
					<div class="detail_leftbar">
						<div class="figure-row first">
							<div class="figure-product figure-640 big">
								<figure>
									<span class="wrapper-fig-image">
										<span class="fig-image" style="background:#FFFFFF;"><img src="<?php echo base_url();?>images/product/<?php echo $img;?>" alt="<?php echo $productDetails->row()->product_name;?>" height="640" width="630"></span>
									</span>
								...
								<p style="text-align:left;"><?php if($this->lang->line('user_by') != '') { echo stripslashes($this->lang->line('user_by')); } else echo "by"; ?> <a href="<?php if ($productDetails->row()->user_id != '0'){echo base_url().'user/'.$productDetails->row()->user_name;}else {echo base_url().'user/administrator';}?>" class="username"><?php if ($productDetails->row()->user_id != '0'){echo $productDetails->row()->full_name;}else {echo 'administrator';}?></a> + <?php echo $productDetails->row()->likes;?> <?php if($this->lang->line('product_others') != '') { echo stripslashes($this->lang->line('product_others')); } else echo "others"; ?></p>
                ...
                <div class="TabbedPanels" id="TabbedPanels1">
                    <ul class="TabbedPanelsTabGroup">
						...
						<li tabindex="0" class="TabbedPanelsTab">
                            ...
                            </div>(<?php  echo $rownum = count($product_feedback); ?>)
						</li>
			...
			<aside id="sidebar" style="padding:0px; width: 255px;">
				<section class="thing-section gift-section">
                	<div class="detail_sidebar">
						<p class="prices"><strong class="price"><?php echo $currencySymbol;?><span id="SalePrice"><?php echo $productDetails->row()->sale_price;?></span></strong> <?php echo $currencyType;?><br></p>
...
<!-- 				    <h3><a href="user/<?php echo $productDetails->row()->user_name;?>" class="url"><img src="images/users/<?php echo $store_img;?>" alt="<?php echo $productDetails->row()->full_name;?>" class="photo"></a>
		...
		<a href="#header" id="scroll-to-top"><span>
		<?php if($this->lang->line('signup_jump_top') != '') { echo stripslashes($this->lang->line('signup_jump_top')); } else echo "Jump to top"; ?></span></a>
