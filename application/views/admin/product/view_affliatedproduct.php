                     ...
                     <div id="tab1">
						<ul>
							...
							<div class="form_input">
	 						...
	 						<li>
								<div class="form_grid_12">
								<label class="field_title" for="description">Web Link</label>
								<div class="form_input">
								<?php 
								if ($product_details->row()->excerpt != ''){
									echo $product_details->row()->web_link;
								}else {
									echo 'Not available';
								}
								?>
										...
										<li>
								<div class="form_grid_12">
								<label class="field_title" for="description">Image</label>
								<div class="form_input">
                          ...
                          <!-- <li>
                            ...
                            <li>
                             ...
                             <li>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title" for="admin_name">Category </label>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/product/display_user_product_list" class="tipLeft" title="Go to product list"><span class="badge_style b_done">Back</span></a>
									</div>
								</div>
								</li>
							</ul>
