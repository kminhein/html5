                     ...
                     <div id="tab1">
						<ul>
							...
							<div class="form_input">
								<input name="product_name" id="product_name" value="<?php echo $product_details->row()->product_name;?>" type="text" tabindex="1" class="large tipTop" title="Please enter the product name"/>
							</div>
							</div>
							</li>
	 						...
	 						<!--<li>
								...
								<div class="form_input">
								<textarea name="description" id="description" tabindex="2" style="width:370px;" class="large tipTop required" title="Please enter the product description"><?php echo $product_details->row()->description;?></textarea>
								</div>
								</div>
							</li>
	 						...
	 						<li>
								...
								<div class="form_input">
								<textarea name="excerpt" id="excerpt" tabindex="3" style="width:370px;" class="large tipTop required" title="Please enter the product Excerpt"><?php echo $product_details->row()->excerpt;?></textarea>
								</div>
								</div>
							</li>-->
                           ...
                           <!-- <li>
								...
								<div class="form_input">
								<input type="text" name="quantity" id="quantity" value="<?php echo $product_details->row()->quantity;?>" tabindex="4" class="large tipTop" title="Please enter the product quantity" />
								</div>
								</div>
							</li>-->
                            ...
                            <!--<li>
								...
								<div class="form_input">
								<input type="text" name="price" id="price" tabindex="9" value="<?php echo $product_details->row()->price;?>" class="large tipTop" title="Please enter the product price" />
								</div>
								</div>
							</li>-->
                             ...
                             <!--<li>
								...
								<div class="form_input">
								<input type="text" name="sale_price" id="sale_price" tabindex="10" value="<?php echo $product_details->row()->sale_price;?>" class="large tipTop" title="Please enter the product sale price" />
								</div>
								</div>
							</li>-->
								...
								<div class="form_input">
								<input type="text" name="web_link" id="web_link" tabindex="9" value="<?php echo $product_details->row()->web_link;?>" class="large tipTop" title="Please enter the product price" />
								</div>
								</div>
							</li>
                               <li>
								...
								<div class="form_input">
                               <?php// echo $product_details->row()->category_id;  ?>
							<select name="category_id" id="fancy-category">
									<option selected="" value="">...</option>
									<?php foreach ($mainCategories->result() as $catRow){?>
									<option <?php if ($catRow->id == $product_details->row()->category_id){echo 'selected="selected"';}?> value="<?php echo $catRow->id;?>"><?php echo $catRow->cat_name;?></option>
									<?php }?>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input name="product_image" id="product_image" type="file" tabindex="7" class="larg" title="Please select product image"/><span class="input_instruction green"></span>
                                        <img src="images/product/<?php echo $product_details->row()->image; ?>"  height="80px" width="80px" />
									</div>
								</div>
								</li>
                                 <li>
