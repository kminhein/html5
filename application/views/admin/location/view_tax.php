                  ...
                  <div class="form_grid_12">
                    ...
                    <div class="form_input">
                      <?php echo $tax_details->row()->meta_description;?>
								...
								<div class="form_grid_12">
									<div class="form_input">
										<a href="admin/location/display_tax_statelist/<?php echo $tax_details->row()->country_id;?>" class="tipLeft" title="Go to location list"><span class="badge_style b_done">Back</span></a>
									</div>
								</div>
								</li>
							</ul>
