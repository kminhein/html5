                    	...
                    	<div id="tab1">
	 						<ul>
								...
								<div class="form_grid_12">
                                    ...
                                    <input name="name" style=" width:295px" id="name" value="" type="text" tabindex="1" class="required tipTop" title="Please enter the location name"/>
									</div>
								</div>
								</li>
                                <li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="contid" style=" width:295px" id="contid" value="" type="text" tabindex="1" class=" tipTop" title="Please enter the iso_code3"/>
									</div>
								</div>
								</li>
                                <li>
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="shipping_cost" style=" width:295px" id="shipping_cost" value="0.00" type="text" tabindex="1" class=" tipTop" title="Please enter the country shipping cost"/>
									</div>
								</div>
								</li>
                                <li>
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input name="shipping_tax" style=" width:295px" id="shipping_tax" value="0.00" type="text" tabindex="1" class=" tipTop" title="Please enter the country tax"/>
									</div>
								</div>
								</li>
								<li>
