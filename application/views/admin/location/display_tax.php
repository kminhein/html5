					...
					<div class="widget_content">
						...
						<tr>
							...
							if ($allPrev == '1' || in_array('2', $tax)){
								...
								if ($mode == '0'){
							?>
								<a title="Click to inactive" class="tip_top" href="javascript:confirm_status('admin/location/change_tax_status/<?php echo $mode;?>/<?php echo $row->id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
							<?php
								}else {	
							?>
								<a title="Click to active" class="tip_top" href="javascript:confirm_status('admin/location/change_tax_status/<?php echo $mode;?>/<?php echo $row->id;?>')"><span class="badge_style"><?php echo $row->status;?></span></a>
							<?php 
								}
							}else {
							?>
							...
							<td class="center">
							<?php if ($allPrev == '1' || in_array('2', $tax)){?>
								<span><a class="action-icons c-edit" href="admin/location/edit_tax_form/<?php echo $row->id;?>" title="Edit">Edit</a></span>
							<?php }?>
								<span><a class="action-icons c-suspend" href="admin/location/view_tax/<?php echo $row->id;?>" title="View">View</a></span>
							<?php if ($allPrev == '1' || in_array('3', $tax)){
							?>
                            	
								<span><a class="action-icons c-delete" href="javascript:confirm_delete('admin/location/delete_tax/<?php echo $row->id;?>')" title="Delete">Delete</a></span>
							<?php  }?>
							</td>
						</tr>
						<?php 
